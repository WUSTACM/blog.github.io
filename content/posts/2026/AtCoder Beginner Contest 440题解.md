...
description: "求$X$翻倍$Y$次的结果 是翻倍不是求幂QAQ"
date: "2026-01-11 00:00:00"
updated: "2026-01-11 00:00:00"
permalink: "/2026/01/11/AtCoder Beginner Contest 440题解"
categories: ["算法"]
tags: ["题解"]
---
...
首先如果可以确定$ans$的值的情况下, 令[$X$, $ans$]之间$A_i$的值的个数为$an$, 如果我们知道$A$在[$X$, $ans$]的第一个下标$l$和最后一个下标$r$, 那么有
$$an = ans - x + 1 - (r - l + 1)$$
