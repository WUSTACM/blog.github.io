...
description: "输入$n$个$0$或者$1$的整数, alice 和 bob 一起在 n 个数上进行游戏, alice 先手, 每人每次可以选择连续至少一个数,然后用 $1-min(所选的所有数)$ 取代所选的连续数, 知道只剩下最后一个数. 如果最后一个数是$0$, 那么 alice 获..."
date: "2026-01-08 00:00:00"
updated: "2026-01-08 00:00:00"
permalink: "/2026/01/08/Codeforces Hello 2026"
categories: ["题解"]
tags: ["题解"]
---
